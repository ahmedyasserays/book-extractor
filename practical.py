...
def get_right_page():
    ...
    x = 600
    images = []
    images.append(pyautogui.screenshot(region=(x, 250, 1200, 700)))
    pyautogui.moveTo(middle[0], 900)
    pyautogui.drag(0, -880, 0.5)
    pyautogui.moveTo(*middle)
    images.append(pyautogui.screenshot(region=(x, 165, 1200, 845)))
    # pyautogui.moveTo(middle[0], 900)
    # pyautogui.drag(0, -750, 0.5)
    # pyautogui.moveTo(*middle)
    # n = 210 
...
name = 'practical' # input('name: ')
pages = 64 # int(input('pages count: '))
